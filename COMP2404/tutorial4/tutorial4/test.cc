...
//network data
const std::string titles[3]={"Dogs","Cats", "Ferrets"};
const std::string subs[3] ={"Sub1", "Sub2", "Sub3"};
const std::string creds[3] ={"0000", "1111", "2222"};
const std::string hosts[3] ={"Irene", "Bob", "Alice"};

//const std::string content[20];  - at end of file
