...
//network data
string TestControl::titles[3]={"Dogs","Cats", "Ferrets"};
string TestControl::subs[3] ={"Sub1", "Sub2", "Sub3"};
string TestControl::creds[3] ={"0000", "1111", "2222"};
string TestControl::hosts[3] ={"Irene", "Bob", "Alice"};
